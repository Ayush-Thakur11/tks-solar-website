...
export function LeadFunnel({ isOpen, onClose }: LeadFunnelProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex items-center justify-center bg-[#081A2F]/70 p-4 backdrop-blur-sm"
      onClick={onClose}
      aria-modal="true"
      role="dialog"
    ...
    >
      <div
        className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#F7F7F4] text-[#081A2F] shadow-[0_35px_80px_rgba(0,0,0,0.45)]"
      ...
      >
        <button
          ...
          onClick={onClose}
          className="absolute right-4 top-4 inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-lg text-slate-700 transition-colors hover:bg-slate-100"
        >
          ×
        </button>

        <div className="border-b border-slate-200 bg-[#081A2F] px-6 py-6 text-white sm:px-8">
          <p className="text-xs font-medium uppercase tracking-[0.28em] text-[#F5A900]">Consultation</p>
          <h3 id="lead-funnel-title" className="mt-3 text-2xl font-semibold tracking-[-0.06em] sm:text-3xl">
            {submitted ? "Thank You!" : "Let's plan your project."}
          </h3>
        </div>
        ...
        <div className="p-6 sm:p-8">
          {submitted ? (
            <div className="space-y-5 py-4 text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#EDE7D7] text-3xl text-[#081A2F]">
                ✓
              </div>
              <div>
                <h4 className="text-2xl font-semibold tracking-[-0.05em]">Your request has been received.</h4>
                <p className="mt-3 text-base text-slate-600">Our team will contact you shortly.</p>
              </div>
              <button
                type="button"
                onClick={onClose}
                className="inline-flex items-center justify-center rounded-full bg-[#F5A900] px-5 py-3 font-medium text-[#081A2F] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f8b62d]"
              >
                Close
              </button>
            </div>
            ...
            <>
              ...
              {step === 1 && (
                <div className="space-y-6">
                  <div>
                    <p className="mb-4 text-lg font-medium">What are you interested in?</p>
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div>
                    <p className="mb-4 text-lg font-medium">What approximate capacity are you considering?</p>
                    <div className="grid gap-3 sm:grid-cols-2">
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <p className="text-lg font-medium">Where is your project located?</p>
